...
1. Clone the repository:
   ...
   ```bash
     git clone https://github.com/GiovanniBombardieri/FruityVice.git
     cd your-repo-name
   ```
...
Project Link: [https://github.com/GiovanniBombardieri/FruityVice](https://github.com/GiovanniBombardieri/FruityVice)
